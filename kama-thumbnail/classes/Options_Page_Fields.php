...
class Options_Page_Fields {
	...
	public function cache_dir(): string {
		...
		'<p class="description">'. __('Full path to the cache folder with 755 rights or above.','kama-thumbnail') .'<br>'.$_SERVER['DOCUMENT_ROOT'].'</p><p class="description">$_SERVER["DOCUMENT_ROOT"]/wp-content/_kama_thumb if you want dynamic path.</p>';
	}
